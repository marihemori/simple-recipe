...
export default {
  ...
  "family:button": {
    input:
      "$reset inline-flex items-center bg-blue-400 text-black text-base font-normal py-3 px-6 rounded-full focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin",
    wrapper: "mb-1",
  ...
  taglist: {
    ...
    tag: "flex items-center my-1 p-1 bg-gray-200 text-sm rounded-full",
    tagWrapper:
  ...
  toggle: {
    altLabel: "block w-full mb-1 font-bold text-base",
    ...
    valueLabel: "font-bold text-base",
